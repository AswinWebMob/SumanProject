...
use crate::{models::user_model::User, TempClientConn}; 
use crate::models::students_model::{Student, StudenMock}; 

#[derive(Clone)]
pub struct MongoRepo {
    conn : mongodb::Collection<Document>, 
} 

impl MongoRepo {

    pub async fn new(conn: Collection<Document>) -> MongoRepo{
        MongoRepo { conn }
    }
